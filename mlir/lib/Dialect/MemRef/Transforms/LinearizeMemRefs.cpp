...
namespace {
struct LinearizeMemRefs
    : public memref::impl::LinearizeMemRefsBase<LinearizeMemRefs> {
  void runOnOperation() override;
};
} // namespace.

std::unique_ptr<OperationPass<ModuleOp>>
mlir::memref::createLinearizeMemRefsPass() {
  return std::make_unique<LinearizeMemRefs>();
}
